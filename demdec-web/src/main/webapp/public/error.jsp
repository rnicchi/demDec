...
<html style="" class=" js no-touch svg inlinesvg svgclippaths no-ie8compat" lang="it"><!--<![endif]-->
	<head>
		...
		<!--<meta charset="utf-8">-->
		<title>DemDec - Dematerializzazione Decreti</title>
	...
	<!-- Header/navigazione top bar -->
		<header class="fixed">
			...
			<div id="Cont_logo"><img class="padd_sx_logo" src="<c:url value="/public/img/logo_DEMDEC.jpg"/>" alt="Vai alla home"></div>
		...
		<div class="container">
			...
			<section id="lanci-servizi" class="margine-bottom">
				...
				<div class="row">
					<div class="large-12 columns">
			    		<p class="center"><strong>Si &egrave; verificato un errore di sistema</strong></p>
					</div>
				</div>
				<div class="row">
					<div class="large-12 columns">
				...
				<div class="row">
					<div class="large-12 columns">
						<p class="center">HTTP 500 Internal server error (Errore interno del server) / HTTP 404 File Not Found ( File non trovato )</p>
					</div>
				</div>
				<div class="row">
					<div class="large-12 columns">
				...
				<div class="row">
					<div class="large-12 columns">
						<p class="center"><span class="fieldNoBold">Si consiglia di riprovare pi&ugrave; tardi, se il problema persiste segnalare il problema all'Assistenza.</span></p>
					</div>
				</div>
				<div class="spacer_sm">&nbsp;</div>
				<div class="spacer_sm">&nbsp;</div>
