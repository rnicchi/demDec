	    ...
	    success: function (response) { 
	  	  ...
	  	  $.each(response, function (i, articleDett) {
	  		if(articleDett.warningCode=='ERRORE'){
	  			 ...
	  			 trHTMLdett='';
	  			 trHTMLdettTit = '';
			//	$("#divErroreDett").append("<div align=center><strong>Errore nel recupero dei datihhh  </strong></div>");
				$("#title_modal_0").append('<div id=title_modal_2 class=bg-tono0><strong>&nbsp;&nbsp;&nbsp;Errore nel recupero dei dati&nbsp;&nbsp;&nbsp;</strong></div>');
			}else {
 ...
 <%--**INIZIO MODALE--%>
   <div>
    ...
    <div>
        ...
        <div id='divErroreDett' class="box_meta_35"></div>
