...
function caricaModaleDettFascSosp(toOpenDett, idFasc){
	    ...
	    success: function (response) { 
	  	  ...
	  	  $.each(response, function (i, articleDett) {
	  		if(articleDett.warningCode=='ERRORE'){
				...
				trHTMLdettTit='<div id=title_modal_2 class=bg-tono0><strong>Raccolta provvisoria Sospesa</strong></div>';
		  		...
		  		trHTMLdett =
		  		 ...
		  		 // '<tr><td><strong>Data Protocollo Ingresso:  </strong></td><td>' + ( (articleDett.protocollo==null || articleDett.protocollo.data==null)?'':convertDate( articleDett.protocollo.data)) +'</td></tr>'+//è la data del protocollo
...
function confermaModaleDettSosp() {
 ...
 <%--**INIZIO MODALE--%>
   <div>
    ...
    <div id="contModal_3" class="box_meta_35" >
    ...
    <div>
     ...
     <button type="button" class="button small " onClick="javascript:confermaModaleDettSosp();">Torna alla lista</button>
