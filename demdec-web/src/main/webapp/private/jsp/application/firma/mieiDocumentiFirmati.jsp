...
<!-- PageName = mieiDocumentiFirmati.jsp -->
...
<fieldset>
	...
	<demdec:displaytag-table name="pageScope.listMySignedDocuments" id="listMySignedDocuments" class="lux width100">
		...
		<demdec:displaytag-column property="rowUpdatedDttm" format="{0,date,dd/MM/yyyy}" titleKey="label.data.firma" title="label.data.firma" class="center"/>
		...
		<demdec:displaytag-column title="" titleKey="label.fad" class="center">
			<demdec:linkButton styleClass="center" action="/private/consultaFascicoloFAD.do" parameter="apriFascicoloFad&signed='F'&funzione=${action}&idFad" parameterValue="${listMySignedDocuments.fascicoli.id}" imageKey="ico.fad.show"  labelKey="alt.apri.fascicoloFad"/>
		</demdec:displaytag-column>
