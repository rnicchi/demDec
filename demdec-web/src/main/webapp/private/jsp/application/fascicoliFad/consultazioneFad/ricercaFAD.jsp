...
<fieldset>
	    ...
	    <div class="small-10 columns">
		    <label for="amministrazione"><spring:message code="label.amministrazione"/></label>
   			<form:select path="amministrazione" >
   				...
   				<c:forEach var="item" items="${amministrazioneList}" varStatus="st">
	...
	<div class="row">
		<div class="small-10 columns">
			<demdec:submit keyValue="label.filtro.data" controllerCode="eseguiRicerca" styleId="btnRicerca" styleClass="button small"/>
			&nbsp;
