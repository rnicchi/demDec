...
<!-- PageName = startInvioAlleFirme.jsp -->
     ...
     <%@include file="/private/jsp/form/ricercaTipoNumeroAnno.jsp" %>  
		  ...
		  <div class="row" >
		    <div class="small-10 columns">
		   		 <button type="button"  class="button small" onclick="javascript:caricaPopup('contModal_0','modaleInvioAFirme');" > <demdec:label  labelKey='label.title.ricercaRed'/></button>
...
<!-- END INCLUDE MODALE Selezione Decreto   modaleRicercaFascicoliFAD.jsp --> 
 ...
 <br>
   <div class="row">
      <div class="small-10 columns" id="invFirmeButton">
      	<%--  <demdec:submit keyValue="button.conferma" controllerCode="ricercaFirmatari" /> --%>
