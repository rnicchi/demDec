...
<%--    <div class="row">  
  ...
  <!-- </div>   
    <div class="row">  --> 
      <div class="small-3 columns left">
         <demdec:label path="dataArrivoA" labelKey="label.raccolteProvvisorie.dataCreazioneA"></demdec:label>
 ...
 <br>
   <div class="row">
      <div class="small-10 columns">
      	 <demdec:submit keyValue="label.filtro.data" controllerCode="ricercaRed" styleId="btnRicercaRed"/>
         <demdec:submit keyValue="label.clean" controllerCode="pulisciRicercaRed" />
       <%--   report
         <demdec:submit keyValue="label.clean" controllerCode="scaricaReport" /> --%>
      </div>
  </div>
