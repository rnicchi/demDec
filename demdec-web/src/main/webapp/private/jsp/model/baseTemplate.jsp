...
<!--<body style="padding-top: 45px;">-->
	...
	%> 
		...
		<div class="container">
			...
			<nssb:form modelAttribute="<%=SessionAttributes.FORM%>">
		    		 <c:if test='${isHelp eq "TRUE"}'>
			    		 <div class="help">
			    		  	<nssb:submit styleClass="subm_help" keyValue="label.empty"  controllerCode="help" />
	           			</div>
			    	</c:if>
				...
				<%-- <nssb:form modelAttribute="<%=SessionAttributes.FORM%>">
	    		 <c:if test='${isHelp eq "TRUE"}'>
		    		 <div  class="large-12 columns right">
   						<nssb:submit keyValue="label.help" controllerCode="help" />&nbsp;&nbsp;
		    		 </div>
		    	</c:if>
					<!--  tiles:insertAttribute name="info" flush="true"/-->
				    <!--  tiles:insertAttribute name="navigator" flush="true"/-->
		...
		<!-- Fine Sezione lanci-servizi -->
			...
			<tiles:insertAttribute name="preView" flush="false"/>
