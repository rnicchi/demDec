...
public class PredTagliatellaForm extends AbstractForm{

	private String tipoDecreto;//usato
	private String decTipoDecreto;
	private String numeDecreto;//usato
	private String annoDecreto;//usato
	...
	private String impattoIndebitamento;
	
	private String altraTipologiaDecreto;
	
	
	
	
	public String getAltraTipologiaDecreto() {
		return altraTipologiaDecreto;
	}
	public void setAltraTipologiaDecreto(String altraTipologiaDecreto) {
		this.altraTipologiaDecreto = altraTipologiaDecreto;
	}
	public String getImpattoIndebitamento() {
		return impattoIndebitamento;
	}
	public void setImpattoIndebitamento(String impattoIndebitamento) {
		this.impattoIndebitamento = impattoIndebitamento;
	}
