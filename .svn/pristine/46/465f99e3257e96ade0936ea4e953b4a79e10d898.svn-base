 ...
 */
public class AnagTipologiaTagliaBO extends AbstractCommonBO implements java.io.Serializable {
    ...
    public AnagTipologiaTagliaBO() {
    }

	
    public AnagTipologiaTagliaBO(String descTipologiaTaglia) {
        this.descTipologiaTaglia = descTipologiaTaglia;
    }
    public AnagTipologiaTagliaBO(String descTipologiaTaglia, String codiAggr) {
       this.descTipologiaTaglia = descTipologiaTaglia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AnagTipologiaTagliaBO) ) return false;
		 AnagTipologiaTagliaBO castOther = ( AnagTipologiaTagliaBO ) other; 
