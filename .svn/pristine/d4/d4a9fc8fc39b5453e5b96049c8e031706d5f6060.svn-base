...
/**
 * Richiesta_removeCollegamentoFascicoloSIPATR_type.java
 *
 ...
 */
            ...
            /**
            *  Richiesta_removeCollegamentoFascicoloSIPATR_type bean class
            */
        
        public  class Richiesta_removeCollegamentoFascicoloSIPATR_type
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = richiesta_removeCollegamentoFascicoloSIPATR_type
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Richiesta_removeCollegamentoFascicoloSIPATR_type.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":richiesta_removeCollegamentoFascicoloSIPATR_type",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "richiesta_removeCollegamentoFascicoloSIPATR_type",
                           xmlWriter);
                   }
                                    ...
                                    if (localIdFascicoloDecretoSIPATR==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"IdFascicoloDecretoSIPATR", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"IdFascicoloDecretoSIPATR");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("IdFascicoloDecretoSIPATR");
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localIdFascicoloDecretoSIPATR==null?null:
                                    localIdFascicoloDecretoSIPATR);
    ...
    public static class Factory{
        ...
        */
        public static Richiesta_removeCollegamentoFascicoloSIPATR_type parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Richiesta_removeCollegamentoFascicoloSIPATR_type object =
                new Richiesta_removeCollegamentoFascicoloSIPATR_type();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"richiesta_removeCollegamentoFascicoloSIPATR_type".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Richiesta_removeCollegamentoFascicoloSIPATR_type)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","IdFascicoloDecretoSIPATR").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setIdFascicoloDecretoSIPATR(null);
                                          reader.next();
