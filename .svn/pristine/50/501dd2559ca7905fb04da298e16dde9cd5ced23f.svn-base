...
/**
 * Richiesta_updateContentDocumentoFascicoloAttoDecreto_type.java
 *
 ...
 */
            ...
            /**
            *  Richiesta_updateContentDocumentoFascicoloAttoDecreto_type bean class
            */
        
        public  class Richiesta_updateContentDocumentoFascicoloAttoDecreto_type
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = richiesta_updateContentDocumentoFascicoloAttoDecreto_type
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for IdDocumentoAttoDecreto
                        */

                        
                                    protected it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid localIdDocumentoAttoDecreto ;
                           ...
                           * @return it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid
                           */
                           public  it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid getIdDocumentoAttoDecreto(){
                               return localIdDocumentoAttoDecreto;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param IdDocumentoAttoDecreto
                               */
                               public void setIdDocumentoAttoDecreto(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid param){
                            
                                            this.localIdDocumentoAttoDecreto=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Richiesta_updateContentDocumentoFascicoloAttoDecreto_type.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":richiesta_updateContentDocumentoFascicoloAttoDecreto_type",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "richiesta_updateContentDocumentoFascicoloAttoDecreto_type",
                           xmlWriter);
                   }
                                    ...
                                    if (localIdDocumentoAttoDecreto==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"IdDocumentoAttoDecreto", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"IdDocumentoAttoDecreto");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("IdDocumentoAttoDecreto");
                                        }
                                     ...
                                     localIdDocumentoAttoDecreto.serialize(new javax.xml.namespace.QName("","IdDocumentoAttoDecreto"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localIdDocumentoAttoDecreto==null?null:
                                    localIdDocumentoAttoDecreto);
    ...
    public static class Factory{
        ...
        */
        public static Richiesta_updateContentDocumentoFascicoloAttoDecreto_type parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Richiesta_updateContentDocumentoFascicoloAttoDecreto_type object =
                new Richiesta_updateContentDocumentoFascicoloAttoDecreto_type();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"richiesta_updateContentDocumentoFascicoloAttoDecreto_type".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Richiesta_updateContentDocumentoFascicoloAttoDecreto_type)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","IdDocumentoAttoDecreto").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setIdDocumentoAttoDecreto(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setIdDocumentoAttoDecreto(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid.Factory.parse(reader));
