	  		...
	  		if(articleDett.warningCode=='ERRORE'){
				...
				trHTMLdettTit='<div id=title_modal_2 class=bg-tono0><strong> </strong></div>';
		  		...
		  		trHTMLdett = 
			  		...
			  		'<tr><td><strong>Esercizio Finanziario:  </strong></td><td>' +( (articleDett.fascicoli==null || articleDett.fascicoli.eserciziDem==null || articleDett.fascicoli.eserciziDem.id==null)?'':articleDett.fascicoli.eserciziDem.id) + '</td></tr>'+
