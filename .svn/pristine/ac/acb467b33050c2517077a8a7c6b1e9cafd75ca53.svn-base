		...
		<fieldset>
			<div class="row">  
				<div class="small-6 columns">
					<demdec:label path="descTipologia" labelKey="label.nuova.tipologia.decreto.obb"></demdec:label> 
			...
			<div class="row">
				<div class="small-10 columns">
					<demdec:submit keyValue="label.confirm" controllerCode="confermaDecreto" />
