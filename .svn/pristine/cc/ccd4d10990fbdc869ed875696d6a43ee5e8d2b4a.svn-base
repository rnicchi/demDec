...
<div>
	...
	<c:if test="${not empty listFascicoliFad}">
		...
		<demdec:displaytag-table class="lux tableDati small-12 columns" name="pageScope.listFascicoliFad" id="listFascicoliFad" >
			<display:caption>
		...
		<%-- 	<demdec:displaytag-column title="">   --%>
			<%--	<form:radiobutton value="${listFascicoliFad_rowNum}"  path="radioButtonDecreti" class="center optim" />  --%>
		<%-- 	questo era già commentato	<demdec:submit styleClass="subm_folder" keyValue="label.empty" titleKey="alt.apri.fascicoloFad" controllerCode="apriFascicoloFad?idFad=${listFascicoliFad.id}"/>
		 --%>
		...
		<demdec:displaytag-column titleKey="label.amministrazione" title="label.amministrazione" class="center"> 
			...
			<demdec:displaytag-column property="ufficioCapofila.descUfficio"
				titleKey="label.ufficio.capofila" />
			<demdec:displaytag-column titleKey="button.predTagliatella.predisponi" style="text-align:center">
				<demdec:submit styleId="btnCrea${listFascicoliFad_rowNum}"   styleClass="subm_none_upd" keyValue="label.empty" title="Predisponi Riepilogo  ${listFascicoliFad.estremiStr}"  alt="Predisponi Riepilogo ${listFascicoliFad.estremiStr}" controllerCode="predisponi?${listFascicoliFad_rowNum-1}" />
			</demdec:displaytag-column>
			<demdec:displaytag-column titleKey="label.predisposizioneTagliatella.visualizzaRiepilogo" style="text-align:center">			
				<demdec:linkButton imageKey="ico.pdf.disabled"  styleClass="padd_sx_logo" action="${action}" parameter="visualizzaLettereDecreto" parameterValue="${listFascicoliFad_rowNum-1}" />
			</demdec:displaytag-column>
			
			
				 <demdec:displaytag-column titleKey="label.title.invioAlFad" class="center color_grey">
						<c:if test="${listFascicoliFad.flagRiepilogoInvioFad eq 1}">
								<demdec:submit styleId="btnCrea${listFascicoliFad_rowNum}"   styleClass="subm_send_sign" keyValue="label.empty" title="Invia al Fad${listFascicoliFad.estremiStr}"  alt="Invia al Fad ${listFascicoliFad.estremiStr}" controllerCode="invioAlFad?${listFascicoliFad_rowNum-1}" />
						</c:if>
				</demdec:displaytag-column>
				  ...
				  <div class="row">
			       <%-- 	<demdec:submit keyValue="button.predTagliatella.predisponi" controllerCode="predisponi" />  --%>
		        		<demdec:submit keyValue="button.nuovaRicerca" controllerCode="nuovaRicerca" />
			     </div> 
