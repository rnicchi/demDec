...
/**
 * Richiesta_changeStatoFascicoloDecretoSIPATR_type.java
 *
 ...
 */
            ...
            /**
            *  Richiesta_changeStatoFascicoloDecretoSIPATR_type bean class
            */
        
        public  class Richiesta_changeStatoFascicoloDecretoSIPATR_type
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = richiesta_changeStatoFascicoloDecretoSIPATR_type
                        ...
                        */
                           ...
                           */
                           public  it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[] getIdFascicoloDecretoSIPATR(){
                              ...
                              /**
                               * validate the array for IdFascicoloDecretoSIPATR
                               */
                              protected void validateIdFascicoloDecretoSIPATR(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[] param){
                              ...
                              */
                              public void setIdFascicoloDecretoSIPATR(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[] param){
                                   ...
                                   validateIdFascicoloDecretoSIPATR(param);
                             ...
                             * @param param it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid
                             */
                             public void addIdFascicoloDecretoSIPATR(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid param){
                                   if (localIdFascicoloDecretoSIPATR == null){
                                   localIdFascicoloDecretoSIPATR = new it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[]{};
                                   }

                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localIdFascicoloDecretoSIPATR);
                               list.add(param);
                               this.localIdFascicoloDecretoSIPATR =
                             (it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[])list.toArray(
                            new it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Richiesta_changeStatoFascicoloDecretoSIPATR_type.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":richiesta_changeStatoFascicoloDecretoSIPATR_type",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "richiesta_changeStatoFascicoloDecretoSIPATR_type",
                           xmlWriter);
                   }
                                       ...
                                       if (localIdFascicoloDecretoSIPATR!=null){
                                            for (int i = 0;i < localIdFascicoloDecretoSIPATR.length;i++){
                                                if (localIdFascicoloDecretoSIPATR[i] != null){
                                                 localIdFascicoloDecretoSIPATR[i].serialize(new javax.xml.namespace.QName("","IdFascicoloDecretoSIPATR"),
                                                           factory,xmlWriter);
                                                } else {
                             ...
                             if (localIdFascicoloDecretoSIPATR!=null) {
                                 for (int i = 0;i < localIdFascicoloDecretoSIPATR.length;i++){
                                    ...
                                    if (localIdFascicoloDecretoSIPATR[i] != null){
                                         ...
                                         elementList.add(localIdFascicoloDecretoSIPATR[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static Richiesta_changeStatoFascicoloDecretoSIPATR_type parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Richiesta_changeStatoFascicoloDecretoSIPATR_type object =
                new Richiesta_changeStatoFascicoloDecretoSIPATR_type();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"richiesta_changeStatoFascicoloDecretoSIPATR_type".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Richiesta_changeStatoFascicoloDecretoSIPATR_type)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","IdFascicoloDecretoSIPATR").equals(reader.getName())){
                                                                    list1.add(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid.Factory.parse(reader));
                                                        ...
                                                        object.setIdFascicoloDecretoSIPATR((it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid.class,
                                                                list1));
