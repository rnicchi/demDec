...
public class PredLetterePreRegForm extends AbstractForm{
	...
	private String radioButtonDecreti;
	...
	private ArrayList<PredLettereTestiForm> predLettereTestiFormList;
	
	private String altroProtocolloEntrata;
	
	
	
	public String getAltroProtocolloEntrata() {
		return altroProtocolloEntrata;
	}
	public void setAltroProtocolloEntrata(String altroProtocolloEntrata) {
		this.altroProtocolloEntrata = altroProtocolloEntrata;
	}
	public ArrayList<PredLettereTestiForm> getPredLettereTestiFormList() {
		return predLettereTestiFormList;
	}
	public void setPredLettereTestiFormList(
			ArrayList<PredLettereTestiForm> predLettereTestiFormList) {
		this.predLettereTestiFormList = predLettereTestiFormList;
	}
	...
	public String getRadioButtonDecreti() {
		return radioButtonDecreti;
	}
	public void setRadioButtonDecreti(String radioButtonDecreti) {
		this.radioButtonDecreti = radioButtonDecreti;
	}
