...
<tiles:insertAttribute name="datiRegistrazioneCdc" flush="false"/>
...
<div class="spacer_sm">&nbsp;</div>
  ...
  <div class="row" >
		  <div class="small-10 columns">
		     ...
		     <button type="button"  class="button small" onclick="return apriPopUpModale('contModal_1_doc');" > <spring:message code="label.consFadCdc.datiProtocolloEntrata"/></button>
<%-- 		   	 <c:choose>
				<c:when test="${ empty fascicoloFad.dataPresaCaricoCdc}">
					<button type="button"  class="button small" onclick="return apriPopUpModale('contModal_3_doc');" > 	<spring:message code="label.consFadCdc.presaCarico"/></button>		     					</c:when>
				<c:otherwise>
					<button type="button"  class="button small" onclick="return apriPopUpModale('contModal_3_doc');" disabled> 	<spring:message code="label.consFadCdc.presaCarico"/></button>
				</c:otherwise>
			 </c:choose> --%>
		<%-- 	 <button type="button"  class="button small" onclick="return apriPopUpModale('contModal_2_doc');" > <spring:message code="label.consFadCdc.datiProtocolloUscita"/></button> --%>
			 <button type="button"  class="button small" onclick="return apriPopUpModale('contModal_5_doc');" > <spring:message code="label.consFadCdc.estremiRegistrazione"/></button>
		...
		<div class="row">
			<div class="large-12 columns">
				...
				<%-- 	<div class="row">
					...
					<div class="row">
						<div class="small-3 columns">
							<label for="dataInvioCdc"><spring:message code="label.consFadCdc.dataInvioCdc"/></label>
					...
					<%-- <div class="row">
						<div class="small-3 columns">
							<label for="numeProtUscita"><spring:message code="label.consFadCdc.numeProtUscita"/></label>
							<form:input path="numeProtUscita" maxlength="50" readonly="true"/>
						</div> 
					
						<div class="small-3 columns left">
							<label for="dataProtUscita"><spring:message code="label.consFadCdc.dataProtUscita"/></label>
			...
			<%-- 	<demdec:displaytag-column property="dataCreazioneFascicoloFormatted"
				...
				<demdec:displaytag-column titleKey="label.raccolteProvvisorie.visualizzaMetadati">
					<a href="javascript:caricaModaleDettFascFad('contModal_0', '${listFascicoliFad_rowNum}');">
						<img  src="<c:url value="/public/img/ico_view_det.png"/>" alt="vai">
					</a>
				</demdec:displaytag-column>
				 --%>
				...
				<demdec:displaytag-column titleKey="label.raccolteProvvisorie.visualizzaMetadati" class="center">
				    ...
				    <a href="javascript:caricaModaleDettFascCdc('contModal_01','${listFascicoliFad.id}');">
						<img src="<c:url value="/public/img/ico_view_det.png"/>"  alt="Visualizza metadati ${listFascicoliFad.estremiStr} - ${listFascicoliFad.descDecreto}" title="Visualizza metadati ${listFascicoliFad.estremiStr} - ${listFascicoliFad.descDecreto}">
					</a>
				</demdec:displaytag-column>
		   ...
		   <demdec:displaytag-table   name="pageScope.listFascicoliRed" id="listFascicoliRed"  class="lux tableDati width100" >
		  		...
		  		<display:caption><span class="nascosto">Tabella fascicoli raccolte provvisorie</span></display:caption>
		   		<demdec:displaytag-column title="" >
						...
						<demdec:submit styleClass="subm_folder" keyValue="label.empty" titleKey="alt.apri.sottoFascicoloRed" controllerCode="apriDocumentiFascicoloRedCdc?rowNum=${listFascicoliRed_rowNum}"/>
	...
	<%-- 				<demdec:displaytag-column property="sistemaProduttore" titleKey="label.raccolteProvvisorie.modificatoDa"  /> --%>
					<demdec:displaytag-column  titleKey="label.raccolteProvvisorie.visualizzaMetadati" class="center" >
							<a href="javascript:caricaModaleFascRedCdc('contModal_02', '${listFascicoliRed_rowNum}'); " >
								<img  src="<c:url value="/public/img/ico_view_det.png"/>"  alt="Visualizza metadati  ${listFascicoliRed.descOggettoRed}" title="Visualizza metadati ${listFascicoliRed.descOggettoRed}">
							</a>			
					</demdec:displaytag-column>
			</demdec:displaytag-table>
		   ...
		   <demdec:displaytag-table   name="pageScope.listFascicoliPat" id="listFascicoliPat"  class="lux tableDati width100" >
		  		...
		  		<display:caption><span class="nascosto">Tabella fascicoli raccolte provvisorie</span></display:caption>
		   		<demdec:displaytag-column title="" >
						...
						<demdec:submit styleClass="subm_folder" keyValue="label.empty" titleKey="alt.apri.sottoFascicoloPat" controllerCode="apriDocumentiFascicoloPatCdc?rowNum=${listFascicoliPat_rowNum}"/>
				...
				<%-- 	<demdec:displaytag-column property="ufficioCreatoreRED.description" titleKey="label.raccolteProvvisorie.origineCreazione"  /> --%>
					...
					<demdec:displaytag-column  titleKey="label.raccolteProvvisorie.visualizzaMetadati" class="center" >
						<a href="javascript: caricaModaleDettFascPatCdc('contModal_03', '${listFascicoliPat_rowNum}'); " >
							<img  src="<c:url value="/public/img/ico_view_det.png"/>" alt="Visualizza metadati  ${listFascicoliPat.descrizione}" title="Visualizza metadati ${listFascicoliPat.descrizione}">
						</a>
					</demdec:displaytag-column>
			</demdec:displaytag-table>
