	     	  ...
	     	  $("#tabellaDecreti2").append(trHTML);
		  	  ...
		  	  $.each(response, function (i, article) {
		  		...
		  		if(article.descSigla=='ERRORE'){
					...
					$("#tabellaDecreti2").empty();
		  			trHTML='';
					$("#divErrore").append("</br></br><label><strong></br></br>&nbsp;&nbsp;&nbsp;Operazione non consentita, il fascicolo di destinazione <b>"+article.numeNumDecreto+"</b>&nbsp;&nbsp;&nbsp;</br> è in stato <b>"+article.descStato+"</b>&nbsp;&nbsp;&nbsp;</strong></label>");
