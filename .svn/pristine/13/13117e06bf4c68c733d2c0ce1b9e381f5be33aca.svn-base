 ...
 */
public class AnagAmminDemBO extends AbstractCommonBO implements
		java.io.Serializable {

	private AnagAmminDemBOId id;
	private EserciziDemBO eserciziDem;
	private String descAmm;
	private String descAmmR;
	private String descAmmFirma;

	public AnagAmminDemBO() {
	}

	public AnagAmminDemBO(AnagAmminDemBOId id, EserciziDemBO eserciziDem,
	...
	public AnagAmminDemBO(AnagAmminDemBOId id, EserciziDemBO eserciziDem,
			String descAmm, String descAmmR, String descAmmFirma) {
		this.id = id;
		this.eserciziDem = eserciziDem;
		this.descAmm = descAmm;
		this.descAmmR = descAmmR;
	...
	public AnagAmminDemBOId getId() {
		return this.id;
	}

	public void setId(AnagAmminDemBOId id) {
		this.id = id;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AnagAmminDemBO))
			return false;
		AnagAmminDemBO castOther = (AnagAmminDemBO) other;
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getDescAmmFirma() == null ? 0 : this.getDescAmmFirma()
						.hashCode());
