 ...
 */
            ...
            /**
            *  BaseServiceFaultType bean class
            */
        
        public  class BaseServiceFaultType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = BaseServiceFaultType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected it.gov.mef.demdec.servizi.dembil.common.ServiceErrorTypeE localErrorDetails ;
                                

                           /**
                           * Auto generated getter method
                           * @return it.gov.mef.demdec.servizi.dembil.common.ServiceErrorTypeE
                           */
                           public  it.gov.mef.demdec.servizi.dembil.common.ServiceErrorTypeE getErrorDetails(){
                            ...
                            /**
                               ...
                               */
                               public void setErrorDetails(it.gov.mef.demdec.servizi.dembil.common.ServiceErrorTypeE param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       BaseServiceFaultType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":BaseServiceFaultType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "BaseServiceFaultType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static BaseServiceFaultType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BaseServiceFaultType object =
                new BaseServiceFaultType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BaseServiceFaultType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BaseServiceFaultType)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
