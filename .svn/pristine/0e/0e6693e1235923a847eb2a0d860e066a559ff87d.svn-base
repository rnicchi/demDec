 ...
 */
            ...
            /**
            *  DocumentoResultType bean class
            */
        
        public  class DocumentoResultType extends it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.DocumentoFile_type
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = documentoResultType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for IdDocumentoOrigine
                        */

                        
                                    protected it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid localIdDocumentoOrigine ;
                           ...
                           */
                           public  it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid getIdDocumentoOrigine(){
                               return localIdDocumentoOrigine;
                           }
                            ...
                            /**
                               ...
                               * @param param IdDocumentoOrigine
                               */
                               public void setIdDocumentoOrigine(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid param){
                            
                                            this.localIdDocumentoOrigine=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DocumentoResultType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":documentoResultType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "documentoResultType",
                           xmlWriter);
                              ...
                              if (localFirmatoTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localIdDocumentoOrigine==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"IdDocumentoOrigine", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"IdDocumentoOrigine");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("IdDocumentoOrigine");
                                        }
                                     ...
                                     localIdDocumentoOrigine.serialize(new javax.xml.namespace.QName("","IdDocumentoOrigine"),
                                        factory,xmlWriter);
                                    }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://mef.gov.it.v1.demdec.internal/servizi/InterfacciaDocumentaleDEMBILTypes_1","documentoResultType"));
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localIdDocumentoOrigine==null?null:
                                    localIdDocumentoOrigine);
    ...
    public static class Factory{
        ...
        */
        public static DocumentoResultType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DocumentoResultType object =
                new DocumentoResultType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"documentoResultType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DocumentoResultType)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                ...
                                reader.next();
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        reader.next();
                                               ...
                                               object.setLength(java.lang.Long.MIN_VALUE);
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","IdDocumentoOrigine").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setIdDocumentoOrigine(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setIdDocumentoOrigine(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid.Factory.parse(reader));
