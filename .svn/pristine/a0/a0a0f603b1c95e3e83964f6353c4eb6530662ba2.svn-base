...
/*	@Autowired
	...
	public String startController(Context context) throws Throwable {
		...
		context.setCurrentNode("DemDec.menu.GestioneProfili");

		//	List<ProfiloTO> listProfili = gestioneProfiliManager.caricaTuttiProfili();
		/*** scegliamo l'ordinamento per codice ***/
		List<ProfiloTO> listProfili = gestioneProfiliManager.caricaTuttiProfiliOrdByCodiProf();
	...
	//	String selectedCodiProfilo = form.getSelectedProfilo();
		String selectedCodiProfilo =  getParameter(context, "selectedCodiProfilo");
		form.setSelectedProfilo(selectedCodiProfilo);
...
//		String selectedProfilo = form.getSelectedProfilo();
		...
		String selectedProfilo =  getParameter(context, "selectedCodiProfilo");
