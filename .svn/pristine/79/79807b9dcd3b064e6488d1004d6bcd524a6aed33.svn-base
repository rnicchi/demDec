...
public interface GestioneFadManager extends AbstractDemManager {
	...
	DocumentiRedTO getDocumentoRedById(String guidDocumento, Long idFascicolo) throws Throwable;
...
//	public List<DescDocumentoTO> findDescDocumentoByTipoDocumento(String tipoDocumento) throws Throwable;
	...
	boolean controlloDecretoNormativo(GestioneFadTO to) throws Throwable;

	List<FascicoliTO> getFascicoliFadPecPartecipazione(FascicoliFadSearhTO to) throws Throwable;
	
	RiepilogoDatiAnagBO findFascicoloAggiornato(long id) throws Throwable;
	RiepilogoDatiAnagTO findFascicoloAggiornatoTO(long id) throws Throwable;
	
	RiepilogoDatiAnagBO saveAggiornamentoFascicolo(RiepilogoDatiAnagBO bo) throws Throwable;
	
	RiepilogoDatiAnagTO saveAggiornamentoFascicoloTO(RiepilogoDatiAnagTO to) throws Throwable;
	
	
	void invioAlFad(List<LettereIgbTO> listaLettere, String user, String nomeFunzione) throws Throwable;
