...
/**
 * Richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type.java
 *
 ...
 */
            ...
            /**
            *  Richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type bean class
            */
        
        public  class Richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static Richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type object =
                new Richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Richiesta_getElencoFascicoliRaccoltaProvvisoriaAttoDecreto_type)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
