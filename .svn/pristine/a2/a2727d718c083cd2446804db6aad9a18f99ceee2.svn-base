 ...
 */
public class DocumentiRedTOId implements java.io.Serializable {
	...
	public DocumentiRedTOId() {
	}

	public DocumentiRedTOId(Long fkNumeIdFascicolo, String codiGuidDocumento) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DocumentiRedTOId))
			return false;
		DocumentiRedTOId castOther = (DocumentiRedTOId) other;
