...
//				throw new Exception(errore);
		...
		public String  riapriFascicolo(Context context) throws Throwable{
			...
			FascicoliTO fascicoloTo=revocaSospensioneFirmeManager.findFascicoloByAnnoTipoNum(Integer.valueOf(anno), Integer.valueOf(tipoFlusso), Integer.valueOf(numero) );
			if(fascicoloTo==null ){
				context.addWarning("info.noDataFound");
				return startView;
			}
			
			EsitoTO esitoTO = revocaSospensioneFirmeManager.riaperturaFascicolo(fascicoloTo);
