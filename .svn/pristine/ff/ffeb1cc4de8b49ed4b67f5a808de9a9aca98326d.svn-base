 ...
 */
            ...
            /**
            *  DataRange_type bean class
            */
        
        public  class DataRange_type
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.util.Date localDataA ;
                           ...
                           */
                           public  java.util.Date getDataA(){
                            ...
                            /**
                               ...
                               * @param param DataA
                               */
                               public void setDataA(java.util.Date param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localDataATracker = true;
                                       } else {
                                          localDataATracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DataRange_type.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":dataRange_type",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "dataRange_type",
                              ...
                              if (localDataATracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"DataA", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"DataA");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("DataA");
                                    }
                                          ...
                                          if (localDataA==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("DataA cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDataA));
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                     ...
                                     if (localDataATracker){
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localDataA != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDataA));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("DataA cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static DataRange_type parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DataRange_type object =
                new DataRange_type();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"dataRange_type".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DataRange_type)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","DataA").equals(reader.getName())){
