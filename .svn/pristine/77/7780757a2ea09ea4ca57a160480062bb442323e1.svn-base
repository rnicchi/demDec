...
/**
 * Richiesta_changeStatoFascicoloAttoDecreto_type.java
 *
 ...
 */
            ...
            /**
            *  Richiesta_changeStatoFascicoloAttoDecreto_type bean class
            */
        
        public  class Richiesta_changeStatoFascicoloAttoDecreto_type
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = richiesta_changeStatoFascicoloAttoDecreto_type
                        ...
                        */
                           ...
                           */
                           public  it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[] getIdFascicoloAttoDecreto(){
                              ...
                              /**
                               * validate the array for IdFascicoloAttoDecreto
                               */
                              protected void validateIdFascicoloAttoDecreto(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[] param){
                              ...
                              */
                              public void setIdFascicoloAttoDecreto(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[] param){
                                   ...
                                   validateIdFascicoloAttoDecreto(param);
                             ...
                             */
                             public void addIdFascicoloAttoDecreto(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid param){
                                   if (localIdFascicoloAttoDecreto == null){
                                   localIdFascicoloAttoDecreto = new it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[]{};
                                   }

                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localIdFascicoloAttoDecreto);
                               list.add(param);
                               this.localIdFascicoloAttoDecreto =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Richiesta_changeStatoFascicoloAttoDecreto_type.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":richiesta_changeStatoFascicoloAttoDecreto_type",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "richiesta_changeStatoFascicoloAttoDecreto_type",
                           xmlWriter);
                   }
                                       ...
                                       if (localIdFascicoloAttoDecreto!=null){
                                            for (int i = 0;i < localIdFascicoloAttoDecreto.length;i++){
                                                if (localIdFascicoloAttoDecreto[i] != null){
                                                 localIdFascicoloAttoDecreto[i].serialize(new javax.xml.namespace.QName("","IdFascicoloAttoDecreto"),
                                                           factory,xmlWriter);
                                                } else {
                             ...
                             if (localIdFascicoloAttoDecreto!=null) {
                                 for (int i = 0;i < localIdFascicoloAttoDecreto.length;i++){
                                    ...
                                    if (localIdFascicoloAttoDecreto[i] != null){
                                         ...
                                         elementList.add(localIdFascicoloAttoDecreto[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static Richiesta_changeStatoFascicoloAttoDecreto_type parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Richiesta_changeStatoFascicoloAttoDecreto_type object =
                new Richiesta_changeStatoFascicoloAttoDecreto_type();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"richiesta_changeStatoFascicoloAttoDecreto_type".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Richiesta_changeStatoFascicoloAttoDecreto_type)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","IdFascicoloAttoDecreto").equals(reader.getName())){
                                                                    list1.add(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid.Factory.parse(reader));
                                                        ...
                                                        object.setIdFascicoloAttoDecreto((it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[])
