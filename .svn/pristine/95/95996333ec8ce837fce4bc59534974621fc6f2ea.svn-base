...
<demdec:useAttribute id="nomeFileAttoDecreto" name="<%=SessionAttributes.NOME_FILE_ATTO_DECRETO%>"/>
<demdec:useAttribute id="fascicoloFad" name="<%=SessionAttributes.FASCICOLO_PEC_PARTECIPAZIONE%>"/>
				...
				<legend><img src="<%=request.getContextPath()%>/public/img/ico_mail_pec.png" alt=""></legend>
					 ...
					 <div class="row">
					   ...
					   <%--  <div class="row">
						 ...
						 <div class="row">
							<div class="small-5 columns">
									<%-- <label for="">${nomeFileAttoDecreto}</label> --%>
									<label for="upFile">Allegato</label>
									<strong><demdec:linkButton  action="private/invioPecPartecipazione.do"  label="${nomeFileAttoDecreto}"  parameter="apriPdf" title="Documento in formato PDF"  parameterValue="${fascicoloFad.id}" /></strong>
							</div>
						</div> 
					 ...
					 <div class="row">
        				<div class="small-10 columns">
        					<demdec:buttons>
								...
								<demdec:submit controllerCode="backFromPec" keyValue="button.annulla" />
