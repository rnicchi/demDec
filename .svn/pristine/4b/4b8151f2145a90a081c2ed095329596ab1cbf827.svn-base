		...
		<demdec:displaytag-table skipDiv="true" name="pageScope.listDocumentiFascicolo" id="listDocumentiFascicolo">
			...
			<demdec:displaytag-column titleKey="label.raccolteProvvisorie.pdf" class="center">
				<c:if test="${listDocumentiFascicolo.documentoFileOperazione ne null}">
					<demdec:linkButton styleClass="padd_sx_logo" action="${action}" imageKey="ico.download.pdf" parameter="scaricaPdfPat"  title="${listDocumentiFascicolo.documentoFileOperazione.fileName}" parameterValue="${listDocumentiFascicolo_rowNum -1}" labelKey="label.raccolteProvvisorie.pdf"/>
				</c:if>
			...
			<demdec:displaytag-column titleKey="label.raccolteProvvisorie.originale" class="center">
				<demdec:linkButton styleClass="padd_sx_logo" action="${action}" imageKey="ico.download.originale" parameter="scaricaOrigPat"  title="${listDocumentiFascicolo.documentoContent.fileName}" parameterValue="${listDocumentiFascicolo_rowNum -1 }" labelKey="label.raccolteProvvisorie.originale"/>
