...
soggetti, gestisce le utenze abilitate secondo profili coerenti con le funzioni istituzionalmente assegnate agli utenti stessi. Inoltre l'applicativo consente la completa tracciabilità del processo e integra al suo interno le funzioni d'archivio assicurando sicurezza e funzionalità nella conservazione dell'atto, flessibilità e facilità nella consultazione.</div>
		<!--[if IE]>
...
<noscript><span id="txtNoScript" title="Per usufruire dell'assistente virtuale è necessario avere javascript attivato. In alternativa potete consultare il manuale utente o l'help online">Assistente virtuale</span></noscript>
</div> --%>
