...
/**
 * Richiesta_changeStatoFascicoloSIPATR_type.java
 *
 ...
 */
            ...
            /**
            *  Richiesta_changeStatoFascicoloSIPATR_type bean class
            */
        
        public  class Richiesta_changeStatoFascicoloSIPATR_type
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = richiesta_changeStatoFascicoloSIPATR_type
                        ...
                        */
                           ...
                           */
                           public  it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[] getIdFascicoloSIPATR(){
                              ...
                              /**
                               * validate the array for IdFascicoloSIPATR
                               */
                              protected void validateIdFascicoloSIPATR(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[] param){
                              ...
                              */
                              public void setIdFascicoloSIPATR(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[] param){
                                   ...
                                   validateIdFascicoloSIPATR(param);
                             ...
                             */
                             public void addIdFascicoloSIPATR(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid param){
                                   if (localIdFascicoloSIPATR == null){
                                   localIdFascicoloSIPATR = new it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[]{};
                                   }

                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localIdFascicoloSIPATR);
                               list.add(param);
                               this.localIdFascicoloSIPATR =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Richiesta_changeStatoFascicoloSIPATR_type.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":richiesta_changeStatoFascicoloSIPATR_type",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "richiesta_changeStatoFascicoloSIPATR_type",
                           xmlWriter);
                   }
                                       ...
                                       if (localIdFascicoloSIPATR!=null){
                                            for (int i = 0;i < localIdFascicoloSIPATR.length;i++){
                                                if (localIdFascicoloSIPATR[i] != null){
                                                 localIdFascicoloSIPATR[i].serialize(new javax.xml.namespace.QName("","IdFascicoloSIPATR"),
                                                           factory,xmlWriter);
                                                } else {
                                 ...
                                 for (int i = 0;i < localIdFascicoloSIPATR.length;i++){
                                    ...
                                    if (localIdFascicoloSIPATR[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("",
                                                                          "IdFascicoloSIPATR"));
                                         elementList.add(localIdFascicoloSIPATR[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static Richiesta_changeStatoFascicoloSIPATR_type parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Richiesta_changeStatoFascicoloSIPATR_type object =
                new Richiesta_changeStatoFascicoloSIPATR_type();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"richiesta_changeStatoFascicoloSIPATR_type".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Richiesta_changeStatoFascicoloSIPATR_type)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","IdFascicoloSIPATR").equals(reader.getName())){
                                                                    list1.add(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid.Factory.parse(reader));
                                                        ...
                                                        object.setIdFascicoloSIPATR((it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.Guid[])
