 ...
 */
public class ProfiloActionTOId implements java.io.Serializable {
	...
	public ProfiloActionTOId() {
	}

	public ProfiloActionTOId(BigDecimal sequIdUtente, BigDecimal sequIdProfilo, BigDecimal sequIdAction,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ProfiloActionTOId))
			return false;
		ProfiloActionTOId castOther = (ProfiloActionTOId) other;
