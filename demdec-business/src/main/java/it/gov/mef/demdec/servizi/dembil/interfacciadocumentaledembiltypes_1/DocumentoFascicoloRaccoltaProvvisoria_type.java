...
/**
 * DocumentoFascicoloRaccoltaProvvisoria_type.java
 *
 ...
 */
            ...
            /**
            *  DocumentoFascicoloRaccoltaProvvisoria_type bean class
            */
        
        public  class DocumentoFascicoloRaccoltaProvvisoria_type
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = documentoFascicoloRaccoltaProvvisoria_type
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.DocumentoMetadataRaccoltaProvvisoria_type localMetadatiDocumento ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.DocumentoMetadataRaccoltaProvvisoria_type getMetadatiDocumento(){
                            ...
                            /**
                               ...
                               */
                               public void setMetadatiDocumento(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.DocumentoMetadataRaccoltaProvvisoria_type param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DocumentoFascicoloRaccoltaProvvisoria_type.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":documentoFascicoloRaccoltaProvvisoria_type",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "documentoFascicoloRaccoltaProvvisoria_type",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static DocumentoFascicoloRaccoltaProvvisoria_type parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DocumentoFascicoloRaccoltaProvvisoria_type object =
                new DocumentoFascicoloRaccoltaProvvisoria_type();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"documentoFascicoloRaccoltaProvvisoria_type".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DocumentoFascicoloRaccoltaProvvisoria_type)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","MetadatiDocumento").equals(reader.getName())){
                                                ...
                                                object.setMetadatiDocumento(it.gov.mef.demdec.servizi.dembil.interfacciadocumentaledembiltypes_1.DocumentoMetadataRaccoltaProvvisoria_type.Factory.parse(reader));
