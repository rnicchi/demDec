...
public interface CroConstants {
	
	 //Cronologico Transazioni
	...
	public final static Short CRO_TRANS_BOLLINA_DOCUMENTI=25;
	public final static Short CRO_TRANS_DELEGA=26;
	
	
	public static final int CODI_CODICE_AMMINISTRAZIONE=8;
