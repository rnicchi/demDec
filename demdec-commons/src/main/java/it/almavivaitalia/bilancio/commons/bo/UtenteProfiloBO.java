 ...
 */
public class UtenteProfiloBO extends AbstractCommonBO implements java.io.Serializable, Comparable<UtenteProfiloBO> {

	private UtenteProfiloBOId id;
	...
	public UtenteProfiloBO() {
	}

	public UtenteProfiloBO(UtenteProfiloBOId id, ProfiloBO profilo,
			UtenteBO utente, Integer flagFirma01, Integer flagModifica01) {
		this.id = id;
	...
	public UtenteProfiloBO(UtenteProfiloBOId id, AnagUfficiBO anagUffici,
			ProfiloBO profilo, AnagAmminDemBO anagAmminDem, UtenteBO utente,
	...
	public UtenteProfiloBOId getId() {
		return this.id;
	}

	public void setId(UtenteProfiloBOId id) {
		this.id = id;
	}
	...
	public void setFlagDelega01(Integer flagDelega01) {
		this.flagDelega01 = flagDelega01;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof UtenteProfiloBO))
			return false;
		UtenteProfiloBO castOther = (UtenteProfiloBO) other;
	...
	@Override
	public int compareTo(UtenteProfiloBO other) {
		int result=0;
		result = this.utente.getPersCognome().compareToIgnoreCase(other.getUtente().getPersCognome());
		result = result!=0?result:this.utente.getPersNome().compareToIgnoreCase(other.getUtente().getPersNome());
		return result;
	}
